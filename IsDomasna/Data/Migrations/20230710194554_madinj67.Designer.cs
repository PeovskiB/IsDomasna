...
namespace IsDomasna.Data.Migrations
{
    ...
    [Migration("20230710194554_madinj67")]
    partial class madinj67
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IsDomasna.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderItemId", "OrderId", "TicketId");
            ...
            modelBuilder.Entity("IsDomasna.Models.Order", b =>
                {
                    b.HasOne("IsDomasna.Models.CinemaUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IsDomasna.Models.CinemaUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OrderItem", b =>
                {
                    b.HasOne("IsDomasna.Models.Order", "Order")
                        .WithMany("OrderItems")
